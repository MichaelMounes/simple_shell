 ...
 * Return: (-1) if builtin not found, 0 if builtin executed successfully, 1 if builtin found but not successful OR (-2) if builtin signals exit()
 */
